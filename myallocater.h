...
public:
	...
	constexpr myallocater() noexcept {}

	constexpr myallocater(const myallocater&) noexcept = default;
	template <class _Other>
	constexpr myallocater(const myallocater<_Other>&) noexcept {}
...
private:
	...
	enum { _MAX_BYTES = 128 };//内存池最大chunk块
...
template <typename T>
char* myallocater<T>::_S_start_free = nullptr;

template <typename T>
char* myallocater<T>::_S_end_free = nullptr;

template <typename T>
size_t myallocater<T>::_S_heap_size = 0;

template <typename T>
typename myallocater<T>::_Obj* volatile myallocater<T>::_S_free_list[_NFREELISTS]
= { nullptr,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr ,nullptr };

template <typename T>
std::mutex myallocater<T>::mtx;